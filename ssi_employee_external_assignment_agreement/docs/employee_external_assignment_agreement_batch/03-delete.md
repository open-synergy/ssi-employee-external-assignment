# Delete Employee External Assignment Agreement Batch
...
- The document number is still **/** (has not been assigned yet).
...
- The record is permanently removed and no longer appears in the list.
