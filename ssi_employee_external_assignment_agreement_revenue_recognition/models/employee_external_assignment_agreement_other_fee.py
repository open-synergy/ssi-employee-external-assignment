...
class EmployeeExternalAssignmentAgreementOtherFee(models.Model):
    _name = "employee_external_assignment_agreement.other_fee"
    _inherit = [
        "employee_external_assignment_agreement.other_fee",
    ]
    ...
    pob_id = fields.Many2one(
        ...
        compute_sudo=True,
        help=(
            "Performance Obligation linked to this other fee line. "
    ...
    def _prepare_pob_data(self):
        ...
        if not manual_field:
            error_message = _(
                """
Context: Create Performance Obligation from agreement other fee
Database ID: %s
