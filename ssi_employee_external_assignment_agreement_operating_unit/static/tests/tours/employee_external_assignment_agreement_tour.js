...
odoo.define(
    ...
    function (require) {
        ...
        // remaining base fields or Save. The Modified Validation section
        // of the same IK (_check_batch_operating_unit) is not covered
        // here -- it is not observable via UI navigation and is verified
        // by an expect_error unit test instead (out of scope for this
        // tour, per odoo-development-ui-test scope-and-boundaries §E2b).
        tour.register(
