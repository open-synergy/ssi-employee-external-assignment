...
odoo.define(
    "ssi_employee_external_assignment_agreement_operating_unit." +
        "employee_external_assignment_agreement_payment_term_tour",
    function (require) {
        "use strict";

        var tour = require("web_tour.tour");

        // IK: docs/employee_external_assignment_agreement_payment_term/
        // 01-create.md (delta, this module) -- Extends
        ...
        // tour stops right after the create form opens -- it does not
        // continue to select an Agreement, fill in the remaining base
        // fields, or Save.
        tour.register(
            ...
            [
                ...
                {
                    // ── Flow 1 (base) -- Open the Payment Terms menu.
